...
class SendWebsiteOption extends Option
{
	...
	public override function press():Bool
	{
		FlxG.save.data.websiteoption = !FlxG.save.data.websiteoption;
		display = updateDisplay();
		return true;
	}
	...
	private override function updateDisplay():String
	{
		return "bobismad website " + (!FlxG.save.data.websiteoption ? "on" : "off");
	}
}
...
class ShakingScreen extends Option
{
	...
	public override function press():Bool
	{
		FlxG.save.data.shakingscreen = !FlxG.save.data.shakingscreen;
		display = updateDisplay();
		return true;
	}
...
class ScaryBS extends Option
{
	...
	public override function press():Bool
	{
		FlxG.save.data.jumpscare = !FlxG.save.data.jumpscare;
		display = updateDisplay();
		return true;
	}
	...
	private override function updateDisplay():String
	{
		return "jumpscare " + (!FlxG.save.data.jumpscare ? "on" : "off");
	}
}
